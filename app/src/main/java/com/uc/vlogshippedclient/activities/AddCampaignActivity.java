...
public class AddCampaignActivity extends AppCompatActivity implements com.tsongkha.spinnerdatepicker.DatePickerDialog.OnDateSetListener {
    ...
    private void setupviews() {
        ...
        CustomSpinnerAdapater customSpinnerAdapter = new CustomSpinnerAdapater(AddCampaignActivity.this, time);
        spinnerStartTime.setAdapter(customSpinnerAdapter);
        spinnerEndTime.setAdapter(customSpinnerAdapter);

        CustomSpinnerAdapater customSpinnerAdapter1 = new CustomSpinnerAdapater(AddCampaignActivity.this, category);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = ProgressDialog.show(AddCampaignActivity.this, "",
                        "Sumitting Campaign, Please wait...", true);

                if(isEmpty()){
                    dialog.dismiss();
                    Toast.makeText(AddCampaignActivity.this, "Please Fill-up the missing blanks", Toast.LENGTH_SHORT).show();
                }else{
                    getUrl();
                }
            }
            ...
            Task<Uri> task = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AddCampaignActivity.this, ""+task.getResult(), Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                }
            });
    ...
    private void sendtodb() {
        ...
        Call<ResponseBody> call = apiInterface.addcampaign(new Campaign(0,UserDb.getUserAccount().getId(),title, start_date, start_time
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (jsonResponseObject.getInt(SponsorActivity.Params.STATUS) == 200) {
                                ...
                                dialog.dismiss();
                                Toast.makeText(AddCampaignActivity.this, "Successfully Added!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent();
                                intent.setClass(AddCampaignActivity.this, MainActivity.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
                                finish();

                            }else{
                                Toast.makeText(AddCampaignActivity.this, "Please check your internet Connection", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        }catch (Exception e){
                            dialog.dismiss();
    ...
    private boolean isEmpty() {
        if(editTitle.getText().toString().isEmpty() ||
                ...
                editPriceRange.getText().toString().isEmpty()){
    ...
    public void btnBack(View v){
        Intent i = new Intent(AddCampaignActivity.this, MainActivity.class);
